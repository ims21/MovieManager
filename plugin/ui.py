...
#			keys += [""]
	...
	def getData(self, current_dir=None):
		...
		def setCurrentRef(path):
			...
			if cfg.pictures.value:
				currentRef.setName('16384:jpg 16384:jpeg 16384:png 16384:gif 16384:bmp 16384:svg')
			return currentRef
...
class MovieManagerCfg(Screen, ConfigListScreen):
	...
	def loadMenu(self):
		...
		self.list.append((_("Enable 'Show duplicates'"), cfg.duplicates, _("Enable item for checking existing csv file and looking for duplicates in movie names.")))
